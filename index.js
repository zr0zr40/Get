...
// الرسالة الجديدة
const newMessage = `
• مرحبًا بكم في بوت فريق ZR0، 

• وحدة الأمن الإلكتروني المتخصصة في الأمن السيبراني والتجسس الاستخباراتي. يُسعدنا تقديم بوت تليجرام لعملائنا للاستخدام في التجسس وفقًا للتوجيهات. يُرجى عدم استخدامه بشكل فردي ومن غير توجيهات فني أو استعمال بدون خبرة كافية أو دراية فنية لأي جهات معنية.

• الدعم الفني https://t.me/+TqKZml5E4VNjYWQ0
